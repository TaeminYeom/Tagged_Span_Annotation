...
class Error(BaseModel):
    ...
    category: str  # e.g., "accuracy/mistranslation", "fluency/grammar", etc.

class ErrorResponse(BaseModel):
    """Response model for GEMBA error analysis"""
    errors: List[Error] = []
...
few_shots = {
    "ende": {
            ...
            "answer": '''{
"errors": [
    {"text": "the account holder", "severity": "Major", "category": "accuracy/omission"},
    {"text": "wäre", "severity": "Minor", "category": "fluency/grammar"},
    {"text": "dir", "severity": "Minor", "category": "fluency/register"},
    {"text": "involvement", "severity": "Major", "category": "accuracy/mistranslation"}
]
}'''
        },
    "encs": {
            ...
            "answer": '''{
"errors": [
    {"text": "ve Vídni", "severity": "Major", "category": "accuracy/addition"},
    {"text": "the stop-start", "severity": "Major", "category": "accuracy/omission"},
    {"text": "partaje", "severity": "Minor", "category": "terminology/inappropriate for context"}
]
}'''
        },
    "zhen": {
            ...
            "answer": '''{
"errors": [
    {"text": "of high-speed rail", "severity": "Major", "category": "accuracy/addition"},
    {"text": "go to the reviews", "severity": "Major", "category": "accuracy/mistranslation"},
    {"text": "etc.,", "severity": "Minor", "category": "style/awkward"}
]
}''',
        },
    "enes": {
...
- Be thorough but precise: Only identify errors when you are confident they are incorrect
...
- Verify each potential error against the source text before identifying
- When in doubt, err on the side of not identifying an error
...
- Identify errors only when you have clear evidence they are incorrect
...
- **Include only the minimal substring that contains the clear error; do not include extra context**
""".strip()
